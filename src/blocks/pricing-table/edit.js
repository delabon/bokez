        ...
        return [
            ...
            isSelected && (
                ...
                <InspectorControls key = {'inspector'} > 
                    ...
                    <PanelColorSettings 
                        title = { __( 'Title Color' , 'bokez') } 
                        initialOpen = { false } 
                        colorValue = { titleColor } 
                        colorSettings={ [ {
                                value: titleColor,
                                colors: bokez.colors,
                                label: __( 'Title Color' , 'bokez'),
                                onChange: ( newColor ) => setAttributes( { titleColor: newColor } ),
                        } ] } >
                    </PanelColorSettings>
    
                    <PanelColorSettings 
                        title = { __( 'Features Color' , 'bokez') } 
                        initialOpen = { false } 
                        colorValue = { featuresColor }
                        colorSettings={ [ {
                                value: featuresColor,
                                colors: bokez.colors,
                                label: __( 'Features Color' , 'bokez'),
                    ...
                    <PanelColorSettings 
                        title = { __( 'Price Color' , 'bokez') } 
                        initialOpen = { false } 
                        colorValue = { priceColor }
                        colorSettings={ [ {
                                value: priceColor,
                                colors: bokez.colors,
                                label: __( 'Price Color' , 'bokez'),
                                onChange: ( newColor ) => setAttributes( { priceColor: newColor } ),
                        } ] } >
                    </PanelColorSettings>
    
                    <PanelColorSettings 
                        title = { __( 'Button Color' , 'bokez') } 
                        initialOpen = { false } 
                        colorValue = { buttonColor } 
                        colorSettings={ [ {
                                value: buttonColor,
                                colors: bokez.colors,
                                label: __( 'Button Color' , 'bokez'),
                                onChange: ( newColor ) => setAttributes( { buttonColor: newColor } ),
                        } ] } >
                    </PanelColorSettings>
    
                    <PanelColorSettings 
                        title = { __( 'Button Background Color ( Hover )', 'bokez' ) } 
                        initialOpen = { false } 
                        colorValue = { buttonBGColor }
                        colorSettings={ [ {
                                value: buttonBGColor,
                                colors: bokez.colors,
                                label: __( 'Button Background Color ( Hover )', 'bokez' ),
                    ...
                    <PanelColorSettings 
                        title = { __( 'Button Color ( Hover)', 'bokez' ) } 
                        initialOpen = { false } 
                        colorValue = { buttonColorHover } 
                        colorSettings={ [ {
                                value: buttonColorHover,
                                colors: bokez.colors,
                                label: __( 'Button Color ( Hover)', 'bokez' ),
