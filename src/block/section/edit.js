...
const layoutOptions = [
    ...
    { 
        key: 'equal', 
        col: 4, name: __( 'Four: 25/25/25/25' ), 
        icon: function ( width = "100", height = "50", fill = "#e5e5e5" ){
            ...
            isSelected && (
                ...
                <InspectorControls>
                    ...
                    <SelectControl
                        ...
                        value= { column_gutter }
                        options={ [
                            { label: __('60px'), value: '60' },
                            { label: __('50px'), value: '50' },
                            { label: __('40px'), value: '40' },
                            { label: __('30px'), value: '30' },
                            { label: __('20px'), value: '20' },
                            { label: __('10px'), value: '10' },
                            { label: __('0'), value: '0' },
                        ] }
